...
export default function HeroSection() {
  ...
  return (
    <motion.main variants={slideUp} initial="initial" animate="enter" className={`${styles.landing} top-0`}>
      <div id="hero"
        className={`${styles.sectionbackground} hero section dark-background`}
        style={{
      ...
      >
        <div className={`${styles.sliderContainer} `}>
          <div ref={slider} className={styles.slider}>
            <p ref={firstText}><span> </span> Samiu Haque - Samiu Haque -</p>
            <p ref={secondText}>Samiu Haque - Samiu Haque -</p>
          </div>
        </div>
